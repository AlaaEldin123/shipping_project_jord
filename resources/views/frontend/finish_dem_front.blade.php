            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_transport">
                        <div class="icon">
                            <img src="{{asset('frontend/img/svg_icon/airplane.png')}}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_transport">
                        <div class="icon">
                            <img src="{{asset('frontend/img/svg_icon/live.png')}}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_transport">
                        <div class="icon">
                            <img src="{{asset('frontend/img/svg_icon/world.png')}}" alt="">
                        </div>
                ...
                <div class="row  align-items-center">
                    <div class="col-xl-5 col-lg-5 col-md-6">
                        <div class="about_image">
                            <img src="{{asset('frontend/img/about/about.png')}}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="testmonial_active owl-carousel">
                        <div class="single_carousel">
                            <div class="single_testmonial text-center">
                                <div class="quote">
                                    <img src="{{asset('frontend/img/svg_icon/quote.svg')}}" alt="">
                                </div>
                                ...
                                <div class="testmonial_author">
                                    <div class="thumb">
                                        <img src="{{asset('frontend/img/case/testmonial.png')}}" alt="">
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="single_location">
                        <h3> <img src="{{asset('frontend/img/icon/address.svg')}}" alt=""> Location</h3>
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="single_location">
                        <h3> <img src="{{asset('frontend/img/icon/support.svg')}}" alt=""> Location</h3>
