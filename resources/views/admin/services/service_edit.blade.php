...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">تعديل الخدمة </h1>
	 ...
	 @enderror 
                                ...
                                <div class=" col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="short_desc"  value="{{ $service->short_desc }}" required class="form-control" placeholder="">
                                                            @error('short_desc') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror 
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <strong>شرح طويل</strong>
                                        <input type="" value="{{ $service->long_desc }}" required name="long_desc" class="form-control" placeholder="">
                                                                                 @error('long_desc') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror 
